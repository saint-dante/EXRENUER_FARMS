  ...
  return (
    <section id="about">
      ...
      <div className="bg-white px-8 pt-16 pb-0">
        {/* Header */}
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 mb-16">
          ...
          <p className="text-sm text-black/60 leading-relaxed self-end max-w-md">
        ...
        <div className="max-w-6xl mx-auto relative z-10 bg-white rounded-2xl border border-black/8 shadow-sm mb-[-80px]">
            ...
            {stats.map((stat) => (
              <div key={stat.label} className="p-8 space-y-3">
                <CountUp
                  ...
                  duration={4000}
                  className="text-5xl font-medium text-black leading-none"
                />
